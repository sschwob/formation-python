...
class TestCoachAnswerEnhanced(unittest.TestCase):
  ...
  def test_10_replies_with_motivation_for_shouted_question(self):
  ...
  def test_11_replies_with_empty_string_for_shouted_work_statement(self):
    self.assertEqual(coach_answer_enhanced("I AM GOING TO WORK RIGHT NOW!"), "")
