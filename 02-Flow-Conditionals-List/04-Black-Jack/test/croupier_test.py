...
class TestCroupier(unittest.TestCase):
  def test_01_state_of_the_game_returns_string(self):
    self.assertIsInstance(state_of_the_game(1, 2), str)

  def test_02_state_of_the_game_contains_scores(self):
